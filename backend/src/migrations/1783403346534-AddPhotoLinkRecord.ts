...
export class AddPhotoLinkRecord1783403346534 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "photo_link_record" ("meetup_id" bigint NOT NULL, "user_id" bigint NOT NULL, "photo_link" character varying(1024) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_a456755cd78d8574755af35e75e" PRIMARY KEY ("meetup_id", "user_id"))`);
